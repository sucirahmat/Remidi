...
<head>
    ...
    <title>Remidi Pemrograman Web</title>
...
<body>
    ...
    <div class="container-md">
        ...
        <h1 class="alert alert-info" style="text-align: center">Bq rara seruni/2101060002</h1>
            <div class="card">
                <div class="card-header">
                    <p class="card-title">Remidi Mahasiswa</p>
                </div>
                <div class="card-body">
