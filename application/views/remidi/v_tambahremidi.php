...
<body>
    ...
    <div class="container-md">
        <h2 class="alert alert-info">Data Remidi</h2>

        <form action="<?= site_url('Controller03/simpanTambah') ?>" method="post">
            <div class="mb-3">
            ...
            <a href="<?= site_url('Controller03/index') ?>" class="btn btn-warning">Kembali</a>
        </form>
